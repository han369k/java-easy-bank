...
CREATE TABLE [ACCOUNT] (
    ...
    [balance]               DECIMAL(19,4)   NULL,                   -- 餘額 (活存/定存用)
    [liability]             DECIMAL(19,4)   NULL,                   -- 負債 (貸款用)
...
EXEC sp_addextendedproperty @name = N'Column_Description', @value = '餘額 (活存/定存適用, 貸款帳戶為NULL)', @level0type = N'Schema', @level0name = 'dbo', @level1type = N'Table', @level1name = 'ACCOUNT', @level2type = N'Column', @level2name = 'balance';
EXEC sp_addextendedproperty @name = N'Column_Description', @value = '負債 (貸款帳戶適用, 還款時直接扣除)', @level0type = N'Schema', @level0name = 'dbo', @level1type = N'Table', @level1name = 'ACCOUNT', @level2type = N'Column', @level2name = 'liability';
...
CREATE TABLE [TRANSACTION] (
    ...
    [counterpart_account]   VARCHAR(12)     NULL,                   -- 對手方帳號 (轉帳用, 存提款NULL)
...
EXEC sp_addextendedproperty @name = N'Column_Description', @value = '對手方帳號 (轉帳時記錄對方帳號, 存提款為NULL)', @level0type = N'Schema', @level0name = 'dbo', @level1type = N'Table', @level1name = 'TRANSACTION', @level2type = N'Column', @level2name = 'counterpart_account';
